 ...
 */
final class Version20210602093437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD categorie_id INT DEFAULT NULL, ADD couleur_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP categorie_id, DROP couleur_id');
    }
}
